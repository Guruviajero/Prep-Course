  ...
  for (let index = 0; index < numeros.length; index++) {
    ...
    if(index != numeros.length - 1){
      if (numeros[index]>numeros[index+1]){
            ...
            numeros[index+1] = numeroMasGrande;
        }
        else{
          numeroMasGrande = numeros[index+1];
          numeros[index+1] = numeroMasGrande;
        }
     }
  }
...
function cuentoElementos(arreglo){
  ...
  //Escribe tu código aquí
  var cantidadelementosmayor = 0  
  for (let index = 0; index < arreglo.length; index++) {
       if (arreglo[index] > 18){
          cantidadelementosmayor = cantidadelementosmayor + 1;
       }
    }
    return cantidadelementosmayor;
}
...
function diaDeLaSemana(numeroDeDia) {
  ...
  //Escribe tu código aquí   
      ...
      for (let index = 0; index < diasSemana.length; index++) {
           if(numeroDeDia == diasSemana[index]){
              if (diasSemana[index] == 1 || diasSemana[index] == 7){
...
function empiezaConNueve(n) {
  ...
  //Escribe tu código aquí
   var cadenaEntero = String(n);
   if (cadenaEntero.charAt(0) == 9){
      return true;
   }
   else {
      return false;
